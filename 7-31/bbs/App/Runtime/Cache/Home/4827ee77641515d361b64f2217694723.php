...
window.onload=function(){
  ...
  xiuxiu.setUploadDataFieldName("face");
  xiuxiu.onInit = function ()
  {
    xiuxiu.loadPhoto("http://127.0.0.1//GetName/7-31/bbs/<?php echo $_SESSION['face'] ?>");//修改为要处理的图片url
  }
          ...
          <form method="post">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-inline">
                <div class="layui-input-inline">
                  <input type="radio" <?php if($user['sex']=="男"){ echo "checked";} ?>  name="sex" value="男" checked title="男">
