            ...
            <table class="layui-table">
                ...
                <?php foreach ($cate as $row) { ?>
                    <tr>
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="cate_edit('编辑','<?php echo U('admin/admin/wedit',array('cid'=>$row['cid']));?>','4','','510')"
        ...
        <script>
            layui.use(['element','laypage','layer','form'], function(){
              ...
              form.on('submit(add)', function(data){
                ...
                $.ajax({
                        url: '<?php echo U('admin/admin/addcate');?>',
                        type: 'post',
                        dataType: 'json',
                        data: data.field,
                    })
            ...
            function cate_del(obj,cid){
                layer.confirm('确认要删除吗？',function(index){
                    //发异步删除数据
                    $.ajax({
                      url: '<?php echo U('admin/admin/leidel');?>',
                      type: 'post',
                      dataType: 'json',
                      data:{cid:cid},
                    })
