        ...
        <div class="x-body">
            <form action="" method="post" class="layui-form layui-form-pane">
                                     ...
                                     <td>
                                        <div class="layui-input-block">
                                         <?php foreach ($row as $res) { ?>
                                            <input name="rules[<?php echo $res['id']; ?>]" type="checkbox" value="<?php echo $res['id']; ?>"> <?php echo $res['title']; ?>  
                                         <?php } ?>
                                        </div>
                                    </td>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" id="desc" name="detail" class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
        ...
        <script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(add)', function(data){
                ...
                $.ajax({
                        url: '<?php echo U('admin/admin/adddata');?>',
                        type: 'post',
                        dataType: 'json',
                        data: data.field,
                    })
