            ...
            <form action="" method="post">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" id="L_title" name="title" value=" <?php echo $edit[0]['title']; ?> " required lay-verify="xbstitle" autocomplete="off" class="layui-input"></div>
              </div>
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <input type="hidden" name="qid" value="<?php echo $_GET['id'] ?>">
                  <textarea id="L_content" name="content"  required  placeholder="请输入内容" class="layui-textarea fly-editor" style="height: 260px;"><?php echo $edit[0]['content']; ?></textarea>
                </div>
...
<script>
    layui.use(['form','jquery','layedit'], function(){
      ...
      form.on('submit(add)', function(data){
        ...
        $.ajax({
          url: '<?php echo U('home/jie/ajaxedit');?>',
          type: 'POST',
          dataType: 'json',
          data: data.field,
        })
